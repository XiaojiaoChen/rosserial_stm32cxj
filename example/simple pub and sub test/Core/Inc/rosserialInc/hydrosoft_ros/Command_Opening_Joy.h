#ifndef _ROS_hydrosoft_ros_Command_Opening_Joy_h
#define _ROS_hydrosoft_ros_Command_Opening_Joy_h
...
namespace hydrosoft_ros
{
  ...
  class Command_Opening_Joy : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return "hydrosoft_ros/Command_Opening_Joy"; };
    virtual const char * getMD5() override { return "a2bcbac20fd8522020764feea83b9ec3"; };
