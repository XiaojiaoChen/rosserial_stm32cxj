#ifndef _ROS_origarm_ros_Seg_ABL_h
#define _ROS_origarm_ros_Seg_ABL_h
...
namespace origarm_ros
{
  ...
  class Seg_ABL : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "origarm_ros/Seg_ABL"; };
